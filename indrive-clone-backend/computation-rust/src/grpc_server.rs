...
// Proto types are generated by build.rs (tonic-build) into OUT_DIR. prost
// emits them at the top level of the file, so we wrap the include in a module
// to give them the `indrive::` namespace the code below expects.
pub mod indrive {
